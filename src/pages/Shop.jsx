...
const ShopPage = () => {
  ...
  return (
    <div>
      <PageHeader
        eyebrow="BROWSE ALL COMPONENTS"
        title="THE FULL"
        accent="SHOP"
        subtitle="Professional-grade parts from every major brand. Filter by category, brand, or price."
      />
            ...
            <div style={{ display: "flex", gap: 6, flexWrap: "wrap" }}>
              {categories.map((cat) => (
                <button
                  ...
                  style={{
                    background:
                      activeCategory === cat ? "#FF5500" : "transparent",
