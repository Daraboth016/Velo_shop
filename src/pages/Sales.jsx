    ...
    <div>
      ...
      >
        ...
        <div style={{ maxWidth: 1200, margin: "0 auto", position: "relative" }}>
          ...
          >
            Up to 30% off premium components. Sale ends Sunday — don't sleep on
            it.
          </p>
          <div style={{ display: "flex", gap: 40 }}>
            {[
              ...
              [
                `Up to ${Math.max(...saleProducts.map(getDiscount))}%`,
                "Max discount",
              ],
              [
                `$${Math.min(...saleProducts.map((p) => p.price))}`,
                "Starts from",
              ],
            ].map(([val, label]) => (
              <div key={label}>
      ...
      <div style={{ maxWidth: 1200, margin: "0 auto", padding: "48px 40px" }}>
        ...
        >
          ...
          <div style={{ fontSize: 12, color: "#444" }}>
            POTENTIAL SAVINGS:{" "}
            <span style={{ color: "#FF5500", fontWeight: 700 }}>
            ...
            return (
              ...
              >
                ...
                <div style={{ padding: "16px 20px 20px" }}>
                  ...
                  <div
                    style={{ fontSize: 11, color: "#00d4aa", marginBottom: 14 }}
                  >
                    You save ${savings}
                  </div>
                  <button
